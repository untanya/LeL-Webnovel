<?php
    ...
    if(isset($_POST['oeuvreImg']) && isset($_POST['oeuvreName']) && isset($_POST['auteur']) && isset($_POST['anneeVO']) && isset($_POST['sourceVoName']) && isset($_POST['linkVO']) && isset($_POST['sourceTrad']) && isset($_POST['statutVO']) && isset($_POST['statutVUS']) && isset($_POST['genre']) && isset($_POST['synopsis']))
    {
        ...
        $check = $bdd->prepare('SELECT oeuvreName FROM addOeuvre WHERE oeuvreName = ?');
                                                    ...
                                                    if(strlen($genre) <= 255){
                                                        if(strlen($synopsis) != null){
                                                            ...
                                                            if(move_uploaded_file($img_loc,$upload_dir . $filename)){
                                                                ...
                                                                $insert = $bdd->prepare('INSERT INTO addOeuvre(oeuvreName, auteur, anneeVO, sourceVoName, linkVO, sourceTrad, statutVO, statutVUS, genre, synopsis) VALUES(:oeuvreName, :auteur, :anneeVO, :sourceVoName, :linkVO, :sourceTrad, :statutVO, :statutVUS, :genre, :synopsis)');
